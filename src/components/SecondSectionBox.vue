      ...
      <div class="row my-5">
        <div class="col-4">
          ...
          <div class="subtitle pt-1">
            <span> October 11th, 205 | </span> <strong>2 comments</strong>
            <p class="py-2">
              Donec finibus sit aemet orci eget ultricies. Praesent posuere ante
              ut erat fringilla, stibulum placerat metus mattis. Aenean dictum
              vitae nisl
            </p>
          </div>
        </div>
...
@import "@/style/secondSectionStyle.scss";
</style>
